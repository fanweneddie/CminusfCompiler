...
public:
    ...
    // create an instruction and insert it into basic block

    // create many kinds of int arithmatic instruction
    ...
    // create many kinds of int comparison instruction
    ...
    // create many kinds of float comparison instruction
    ...
    // create many kinds of float arithmatic instruction
